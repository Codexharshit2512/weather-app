...
class Main extends Component {
  ...
  searchLocation = (location) => {
    fetchPlaces(location)
      ...
      .catch((err) => {
        this.setState(
          { places: [], geoCodeErr: err, isForecastLoading: false },
          () => console.log(err)
        );
      });
  };
    ...
    return (
      <React.Fragment>
        ...
        <Weather
          ...
          geoErr={this.state.geoCodeErr}
          forecast={this.fetchWeather}
          forecastData={this.state.weatherForecast}
          forcastErr={this.state.forcastErr}
          location={this.state.selectedLoc}
          loading={this.state.isForecastLoading}
        />
      </React.Fragment>
    );
  }
